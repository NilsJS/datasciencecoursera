...
7-fold cross validation did the trick.  We'll go with modelFit3.
...
**TODO**: Predict out-of sample error!

Ref: http://www.dataschool.io/simple-guide-to-confusion-matrix-terminology/
