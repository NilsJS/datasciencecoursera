...
# Get Term Doc Matrix 
docs.en.tdm <- TermDocumentMatrix(docs.en)
# Get words that occur at least 10 times in each doc
docs.en.words10 <- findFreqTerms(docs.en.tdm, 10)
# Get words that occur at least 100 times in each doc
docs.en.words100 <- findFreqTerms(docs.en.tdm, 100)
#docs.en.term.freq1000 <- getTermFreq(docs.en.term.matrix, 1000)
```

```{r}
# df <- as.data.frame(inspect(docs.en.tdm[docs.en.words100, 1:3]))
# df$total <- df[1] + df[2] + df[3]
#arrange(df, desc(total))

inspect(docs.en.tdm[docs.en.words100, 1:3])
