...
The interpretation of this model is that adding 1000 lb of weight to a car with *manual transmission* **decreases** MPG by `r round(abs(coef_m3[3,1]), 3)`, provided you keep the same hp.  Adding 1 hp to a car with *manual transmission*, while keeping weight constant, **decreases** MPG by `r round(abs(coef_m3[4,1]), 3)`.  
